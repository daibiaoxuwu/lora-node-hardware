...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_center_freq(470e6, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'D:\\test_interfere.bin', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_file_sink_0.set_block_alias("`")
