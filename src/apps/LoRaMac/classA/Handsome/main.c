...
static void InitRx(uint32_t targ_freq)
{
    ...
    Radio.SetChannel(targ_freq);
    Radio.SetRxConfig(MODEM_LORA, 0, CONFIG_SF, 1, 0, 8, 5000, false, 0, true, 0, 0, false, false);
    Radio.Rx(0);
}
